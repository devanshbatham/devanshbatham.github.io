...
I highly recommend everyone just starting in this field to watch [this video](https://www.youtube.com/watch?v=_160oMzblY8). This is a very basic visual introduction to the concepts behind a blockchain. Where the instructor demonstrates the idea of an immutable ledger using an interactive web demo.

Web Demo can be found [here](https://andersbrownworth.com/blockchain/)
...
- [ ]  [Building a Minimal Blockchain in Python](https://towardsdatascience.com/building-a-minimal-blockchain-in-python-4f2e9934101d)
...
That was all from my side in this article; See you very soon in [Genesis 0x03](https://devansh.xyz/blockchain-security/2021/10/01/genesis-0x03.html), Keep warm, stay hydrated and have good day ahead :)
